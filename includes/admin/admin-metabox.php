<table class="form-table lava-item-add-form">
	...
	<tr>
		...
		<td>
			<input type="hidden" name="lava_pt[featured]" value="0">
			<input type="checkbox" name="lava_pt[featured]" value="1" <?php checked( '1' === get_post_meta( $post->ID, '_featured_item', true ) ); ?>>
		</td>
	</tr>
