...
class Lava_Directory_Manager_Func extends Lava_Directory_Manager {
	...
	public function is_crossdomain() {
		$strReturn = false;
		if( method_exists( Lava_Directory_Manager_Admin::instance(), 'get_settings' ) )
			$strReturn = Lava_Directory_Manager_Admin::instance()->get_settings( 'crossdomain' ) == '1';
		return $strReturn;
	}
